...
public class SimpleMapTest {
    ...
    public void compileProjection() {
        ...
        CompiledProjection<Employee> compiledPredicate = simpleMap.compile(new ProjectionInfo<Employee>(Employee.class, true, new SqlPredicate("age==$age and iq==$iq and height>10")));
//        Map<String, Object> bindings = new HashMap<String, Object>();
//        bindings.put("age", 100);
//        bindings.put("iq", 100l);
//        compiledPredicate.execute(bindings);
